...
| <a name="input_eks_endpoint_url"></a> [eks\_endpoint\_url](#input\_eks\_endpoint\_url) | EKS cluster endpoint URL | `string` | n/a | yes |
...
| <a name="input_vpc_id"></a> [vpc\_id](#input\_vpc\_id) | VPC ID where the EKS cluster is running | `string` | n/a | yes |
